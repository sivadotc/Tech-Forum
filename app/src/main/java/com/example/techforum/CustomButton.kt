...
fun CustomTextField(
    ...
    visualTransformation: VisualTransformation? = null // Add the nullable parameter
) {
    ...
    OutlinedTextField(
        ...
        modifier = modifier.padding(8.dp).onFocusEvent { event ->
            if (event.isFocused) {
        ...
        visualTransformation = visualTransformation ?: PasswordVisualTransformation(), // Apply the default transformation if null
